...
public abstract class Barco {
   ...
   * @param dias
   * @return Verdadero o Falso, según se haya realizado con éxito la operación.
   */
   ...
   * el siguiente criterio, según el valor del parámetro "orden":
   *  - Si vale 1: compara las matriculas alfabéticamente.
   *  - Si vale 2: compara las esloras.
  ...
  public boolean menorQue(Barco otroBarco, int orden){
    ...
    switch (orden) {
      case 1:
        return this.matricula.compareTo(otroBarco.getMatricula()) < 0;
      case 2:
        return this.eslora < otroBarco.getEslora();
      case 3:
        return this.precioAlquiler() < otroBarco.precioAlquiler();
    }
    return false;
  }
   ...
   * Método que compara el objeto "this" con el que recibe como parámetro con
   * el siguiente criterio, según el valor del parámetro "orden":
   *  - Si vale 1: compara las matriculas.
   *  - Si vale 2: compara las esloras.
   *  - Si vale 3: compara los precios de alquiler.
   * 
   * @param otroBarco, objeto con el que se compara
  ...
  public void verDatos(){
    ...
    System.out.println("Alquiler "+(conPatron?"con":"sin")+" patrón");
  }
